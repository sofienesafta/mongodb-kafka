...
db.createRole( {role:"writecollDoctor", privileges: [ {resource:{db: "patient", collection:"medical_action"},
...
db.createRole({role:"caremakerRole", privileges: [ {resource:{db: "patient", collection:"sensorlogs"},
  actions: ["find","collStats"]}, {resource:{db: "patient", collection:"medical_action"},
